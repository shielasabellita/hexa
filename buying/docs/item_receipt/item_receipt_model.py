...
class ItemReceipt(models.Model):
    ...
    code = models.CharField(max_length=120, default="IR_{7}")   ## system generated

    # purchase order link
    purchase_order = models.ForeignKey(PurchaseOrder, on_delete=models.CASCADE, null=True) # FK
    ...
    net_amount = models.DecimalField(decimal_places=2, max_digits=10, default=0)
