# Generated by Django 3.2.9 on 2022-01-19 15:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchase_item', models.IntegerField(choices=[(1, 1), (0, 0)], default=1)),
                ('conversion_detail', models.CharField(blank=True, max_length=450)),
                ('supplier_items', models.CharField(blank=True, max_length=450)),
            ],
        ),
        migrations.CreateModel(
            name='ItemCatBrand',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_both', models.IntegerField(choices=[(1, 1), (0, 0)], default=0)),
            ],
        ),
        migrations.CreateModel(
            name='Series',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='fixed_asset_group', to='api.itemgroup'),
        ),
        migrations.AddField(
            model_name='item',
            name='item_group',
        ...
        migrations.AddField(
            model_name='item',
            name='vat_group',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='vat_group', to='api.vatgroup'),
        ),
        migrations.CreateModel(
            name='Domain',
            fields=[
