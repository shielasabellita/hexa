...
# serializer
from .withholding_tax_serializer import WithHoldingTaxGroupSerializer

# other packages
import json


class WithHoldingTaxGroupView(Document):

    def __init__(self, *args, **kwargs):
        args = (WithHoldingTaxGroup, WithHoldingTaxGroupSerializer)
