...
# serializer
from .customer_discounts_serializer import CustomerDiscountsSerializer

# other packages
import json


class CustomerDiscountsView(Document):

    def __init__(self, *args, **kwargs):
        args = (CustomerDiscounts, CustomerDiscountsSerializer)
