...
# model
from .supplier_discounts.supplier_discounts_model import SupplierDiscounts

# serializer
from .supplier_discounts.supplier_discounts_view import SupplierDiscountsSerializer
